...
interface BlockingProcess{
    ...
    public function NotifyWhileUnblocked($userEmail, $subject, $body);
    public function NotifyWhileblocked($userEmail, $subject, $body);
...
class NotificationController implements BlockingProcess
{
